...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    /////////////////////////////////////////////////////////////
    public static double autoDriveScoreXP = 0.09;
    ...
    public static double autoDriveScoreYP = 0.18;
    public static double autoDriveScoreYI = 0.00001;
    public static double autoDriveScoreYD = 0.0;
    public static double autoDriveScoreYTolerance = 1.2;
  ...
  public static final class ArmConstants{
    ...
    public static final ArmPosition restPosition = new ArmPosition(107.3, -170.46, 0, 20, true);
    ...
    public static final ArmPosition pickupToRestIntermediatePosition = new ArmPosition(17.44, 10.2, 0, 20, false);
    public static final ArmPosition yeetCubePosition = new ArmPosition(22.8, 47.8, 0, 0, false);
    public static final ArmPosition grabUprightConePosition = new ArmPosition(32.7, -3.5, 0, -5, false);
