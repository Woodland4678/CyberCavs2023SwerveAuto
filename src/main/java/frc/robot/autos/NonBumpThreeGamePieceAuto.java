...
public class NonBumpThreeGamePieceAuto extends SequentialCommandGroup {
  ...
  public NonBumpThreeGamePieceAuto(SwerveDrive s_Swerve, Arm s_Arm,  Joystick operatorJoystick) {
    PathPlannerTrajectory goTo2ndGamePiece = PathPlanner.loadPath("Non Bump Path 1", new PathConstraints(2, 2));
    PathPlannerTrajectory bring2ndGamePieceBack = PathPlanner.loadPath("Non Bump Path 2", new PathConstraints(2, 2));
    PathPlannerTrajectory goTo3rdGamePiece = PathPlanner.loadPath("Non Bump Path Game Piece 3", new PathConstraints(2, 2));
    PathPlannerTrajectory bring3rdGamePieceBack = PathPlanner.loadPath("Non Bump Path Move 3rd Piece", new PathConstraints(2, 2));
