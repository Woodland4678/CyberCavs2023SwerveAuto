...
public class AutoAlignSingleSubstationGreen extends CommandBase {
  Arm s_Arm;
  SwerveDrive s_Swerve;
  PIDController xController = new PIDController(Constants.Swerve.autoDriveCubePickupXP + 0.02, Constants.Swerve.autoDriveCubePickupXI, Constants.Swerve.autoDriveCubePickupXD);
  ...
  public AutoAlignSingleSubstationGreen(SwerveDrive s_Swerve, Arm s_Arm) {
    this.s_Arm = s_Arm;
  ...
  public void initialize() {
    ...
    s_Swerve.setLimelightPipeline(1);//6
      ...
      switch(grabState) {
        case 0:
          ...
          if (s_Swerve.limelightHasTarget() == 1) {
            ...
            if (xController.getPositionError() < 10) { //don't move forward until x is close enough
              ySpeed = 1.5; //2
            }
